  ...
  return (
    <div
      className={`fixed z-[1000] inset-0 bg-black bg-opacity-50 transition-opacity ${
        isOpen ? "opacity-100" : "opacity-0 pointer-event-none"
      }`}
              ...
              products.map((item, index) => (
                ...
                >
                  <div className="flex flex-col lg:flex-row ">
                    ...
                    <div className="flex flex-row justify-start md:justify-end items-center mt-2">
                      <button
                        onClick={() => {
                          handleQuanity("decrement", item._id);
                        }}
                      ...
                      <button
                        onClick={() => {
                          handleQuanity("increment", item._id);
                        }}
                        className="size-6 flex items-center px-1.5 rounded-full bg-gray-200 text-gray-700 hover:bg-primary hover:text-white "
                      >
                        +
                      </button>
                      <div className="ml-1">
